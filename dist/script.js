...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var slider = new _modules_slider_sliderMain__WEBPACK_IMPORTED_MODULE_0__["default"]({
    btns: '.next',
    page: '.page'
  }),
      player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay');
  slider.render();
  player.init();
});
...
function () {
  function VideoPlayer(triggers, overlay) {
    ...
    this.closers = document.querySelector('.close');
  }
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindCloseBtn() {
      ...
      this.closers.addEventListener('click', function () {
